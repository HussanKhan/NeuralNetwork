...
textData = [
    ...
    # 'Event cameras are still uncommon, though. They cost thousands of dollars and are not usually seen outside of a research lab. Falanga says they’ll eventually hit the mainstream, but it will take years of development to bring them down to a reasonable cost. “Absolutely I think in the long run I think we’ll see more and more usage of these cameras,” he says.',
...
hiddenPoss = int(inputSize)

net = RNN(learningRate=0.2, hiddenSize=hiddenPoss)
...
net.trainNetwork(inputs, targets, epochs=6)
